      ...
      {message.imagesCount && (
        <div className="flex flex-col">
          ...
          <div className="flex gap-1.25 items-center mr-auto pb-1.5">
            <button className="rounded-lg border-solid border-[1px] border-gray-600 px-3.75 py-2.75 bg-gray-700 cursor-pointer">
              <p className="text-gray-0">Reroll</p>
            </button>
            <button className="rounded-lg border-solid border-[1px] border-gray-600 px-3.75 py-2.75 bg-gray-600 cursor-pointer">
              <p className="text-gray-0">Variation</p>
            </button>
            <button className="rounded-lg border-solid border-[1px] border-gray-600 px-3.75 py-2.75 bg-gray-700 cursor-pointer">
              <p className="text-gray-0">upscale</p>
            </button>
          </div>
        </div>
      )}
